...
6 つの汎用ロール（Explorer / Planner / Generator / Critic / Evaluator / Executor）で実務の大半をカバーする。専門エージェントは必要時のみ外部カタログから補完する（0〜2 個に抑える）。
...
|---|---|---|---|---|---|---|
| Explorer | o | x | x | x | o | o |
| Planner | o | x | x | x | o | o |
| Generator | o | o | o | △ | o | o |
| Critic | o | x | x | x | o | o |
| Evaluator | o | x | x | o | o | x |
| Executor | o | x | x | o | x | x |
